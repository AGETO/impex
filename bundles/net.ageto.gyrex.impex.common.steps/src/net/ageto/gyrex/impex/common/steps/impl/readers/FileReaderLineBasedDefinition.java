 ...
 *
 */
public final class FileReaderLineBasedDefinition implements IProcessStepDefinition{

	private static final String NAME = "FileReaderLinedBased";
	private static final String DESCRIPTION = "A simple line based file reader";

	public static enum InputParamNames {
		INPUT_FILENAME, INPUT_CHARSET;
	}
	...
	static {
		...
		// optional
		IN_PARAM_MAP.put(InputParamNames.INPUT_CHARSET, String.class);
